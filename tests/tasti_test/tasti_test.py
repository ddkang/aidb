...
class TastiTests():
  ...
  def test(self):
    ...
    logger.info('The shape of cluster representative ids', representative_vector_ids.shape)
    ...
    logger.info('The total number of cluster representatives is:', len(self.tasti.reps))
