...
class NestedQueryTests(IsolatedAsyncioTestCase):
  ...
  async def test_nested_query(self):
    ...
    queries = [
      ...
      (
        'full_scan',
        '''SELECT * FROM objects00 WHERE object_name='car' AND frame < (SELECT AVG(frame) FROM blobs_00);''',
        '''SELECT * FROM objects00 WHERE object_name='car' AND frame < (SELECT AVG(frame) FROM blobs_00);'''
      ),
      ...
      (
        'full_scan',
        '''SELECT * FROM colors02 WHERE frame >= 10000 AND object_id > (SELECT AVG(object_id) FROM objects00);''',
        '''SELECT * FROM colors02 WHERE frame >= 10000 AND object_id > (SELECT AVG(object_id) FROM objects00);'''
      ),
      ...
      (
        'full_scan',
        '''SELECT * FROM colors02 WHERE object_id > (SELECT AVG(object_id) FROM objects00) OR object_id > (SELECT AVG(object_id) FROM colors02);''',
        '''SELECT * FROM colors02 WHERE object_id > (SELECT AVG(object_id) FROM objects00) OR object_id > (SELECT AVG(object_id) FROM colors02);''',
      ),
      ...
      (
        'full_scan',
        '''SELECT * FROM colors02 WHERE object_id > (SELECT AVG(object_id) FROM objects00 WHERE y_max < (SELECT AVG(object_id) FROM colors02));''',
        '''SELECT * FROM colors02 WHERE object_id > (SELECT AVG(object_id) FROM objects00 WHERE y_max < (SELECT AVG(object_id) FROM colors02));''',
      ),
      ...
      (
        'full_scan',
        '''SELECT * FROM colors02 WHERE object_id IN (SELECT object_id FROM objects00 WHERE frame < 1000);''',
        '''SELECT * FROM colors02 WHERE object_id IN (SELECT object_id FROM objects00 WHERE frame < 1000);'''
      ),
      ...
      (
        'full_scan',
        '''SELECT * FROM colors02 WHERE object_id IN (SELECT object_id FROM objects00 WHERE x_min < 364);''',
        '''SELECT * FROM colors02 WHERE object_id IN (SELECT object_id FROM objects00 WHERE x_min < 364);'''
      ),
      ...
      (
        'full_scan',
        '''SELECT * FROM colors02 WHERE object_id IN (SELECT object_id FROM colors02 WHERE color = 'grayish_blue');''',
        '''SELECT * FROM colors02 WHERE object_id IN (SELECT object_id FROM colors02 WHERE color = 'grayish_blue');'''
      ),
