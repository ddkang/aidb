  ...
  async def test_nested_query(self):
    ...
    "test_query_0": {
        QueryParameters.QUERY_STR:
            ...
            ''',
        QueryParameters.NORMALIZED_QUERY_STR: 
        ...
        QueryParameters.CORRECT_TABLES: 
            [{'colors02', 'objects00'}],
        QueryParameters.NUM_OF_SELECT_CLAUSES: 
            3
    },
    # test table alias
    "test_query_1": {
          ...
          UdfQueryParameters.DATAFRAME_SQL: {
              UdfQueryParameters.UDF_MAPPING: [
                  {UdfQueryParameters.COL_NAMES: 
                      ['col__0', 'col__1'],
                   UdfQueryParameters.FUNCTION_NAME: 
                      'function1',
                   UdfQueryParameters.RESULT_COL_NAME: 
                      ['function__0']},
                  {UdfQueryParameters.COL_NAMES: 
                      [],
                   UdfQueryParameters.FUNCTION_NAME: 
              ...
              UdfQueryParameters.SELECT_COL: 
                  ['col__0', 'function__0', 'col__2', 'function__1'],
              UdfQueryParameters.FILTER_PREDICATE: 
                  None
          }
    },
